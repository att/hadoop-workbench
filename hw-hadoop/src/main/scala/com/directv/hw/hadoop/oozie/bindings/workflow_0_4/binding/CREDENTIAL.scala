...
@XmlType(name = "CREDENTIAL", propOrder = Array("property"), namespace = "uri:oozie:workflow:0.4") object CREDENTIAL {
...
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "CREDENTIAL", propOrder = Array("property"), namespace = "uri:oozie:workflow:0.4") class CREDENTIAL {
