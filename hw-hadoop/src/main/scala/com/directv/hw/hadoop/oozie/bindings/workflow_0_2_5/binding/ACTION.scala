...
@XmlRootElement(name = "action", namespace = "uri:oozie:workflow:0.2.5")
@XmlType(name = "ACTION", propOrder = Array("name", "cred",
  ...
  , namespace = "uri:oozie:workflow:0.2.5") class ACTION {
