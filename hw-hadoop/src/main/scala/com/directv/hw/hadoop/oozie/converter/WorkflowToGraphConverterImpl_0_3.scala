...
import com.directv.hw.hadoop.oozie.bindings.workflow_0_3.binding._
...
class WorkflowToGraphConverterImpl_0_3 extends WorkflowToGraphConverterBase with LazyLogging {

  // workflow version this converter supports
  override def getSupportedWorkflowVersion: String = "0.3"

  import WorkflowConverter.Oozie

  def getJsonSchemaAsString: String = com.directv.hw.hadoop.oozie.bindings.workflow_0_3.pluginDescription.getJsonSchemaAsString
  ...
  override lazy val pluginSerializers: List[(Class[_], Class[_])] =
    com.directv.hw.hadoop.oozie.bindings.shell_action_0_3.pluginDescription.additionalSerializers ++
      ...
      com.directv.hw.hadoop.oozie.bindings.workflow_0_3.pluginDescription.additionalSerializers ++
  ...
  override protected def parse(xml: String): ParsedWorkflow = {
    ...
    val propertiesForStartNode: String = getStartPropertiesJson(javaWfApp.getCredentials)
        ...
        Some(
          outs.collect {
            case out: FORKTRANSITION if out.getStart != null =>
              Connection(fork.getName, out.getStart, Oozie.connectors.ok)
          }.toList
        )
      case join: JOIN =>
        if (join.getTo != null)
  ...
  /**
   * Global workflow types wrapper
   */
  def getStartPropertiesJson(credentials: CREDENTIALS): String = {
  ...
  override protected def getNodeBindings: List[Class[_]] = {
    List(
      classOf[com.directv.hw.hadoop.oozie.bindings.workflow_0_3.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.hive_action_0_3.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.shell_action_0_3.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.sqoop_action_0_3.binding.ACTION]
    )
  }
}
