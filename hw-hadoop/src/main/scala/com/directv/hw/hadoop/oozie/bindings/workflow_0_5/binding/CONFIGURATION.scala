...
@XmlType(name = "CONFIGURATION", propOrder = Array("property"), namespace = "uri:oozie:workflow:0.5") object CONFIGURATION {
...
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "CONFIGURATION", propOrder = Array("property"), namespace = "uri:oozie:workflow:0.5") class CONFIGURATION {
  @XmlElement(required = true)
