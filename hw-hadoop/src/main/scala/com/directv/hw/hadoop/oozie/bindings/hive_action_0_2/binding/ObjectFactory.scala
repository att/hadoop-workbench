...
@XmlRegistry object ObjectFactory {
  private val _Hive_QNAME: QName = new QName("uri:oozie:hive-action:0.2", "hive")
}
...
@XmlRegistry class ObjectFactory {
  ...
  @XmlElementDecl(namespace = "uri:oozie:hive-action:0.2", name = "hive") def createHive(value: ACTION): JAXBElement[ACTION] =
