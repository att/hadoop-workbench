package com.directv.hw.hadoop.oozie.bindings.hive_action_0_5

import java.io.InputStream
import java.lang.reflect.Type

import com.directv.hw.core.exception.DapException
import com.directv.hw.hadoop.oozie.bindings.hive_action_0_5.WorkflowSerializerCommon._
import com.directv.hw.hadoop.oozie.bindings.hive_action_0_5.binding._
...
object pluginDescription {
  val jsonSchemaPath = "oozie/metadata/hive_action_0_5/jsonSchema.json"
  ...
  override def deserialize(actionJson: JsonElement, typeOfT: Type, context: JsonDeserializationContext) = {
    ...
    if (json != null) {
      ...
      if (json.has("argument")) {
        ...
        if (action.getArgument.isEmpty) action.setArgument(null)
      }
      if (json.has("file")) {
