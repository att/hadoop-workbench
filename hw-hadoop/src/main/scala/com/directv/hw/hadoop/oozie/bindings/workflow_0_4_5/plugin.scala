package com.directv.hw.hadoop.oozie.bindings.workflow_0_4_5

import java.io.InputStream
import java.lang.reflect.Type

import com.directv.hw.core.exception.DapException
import com.directv.hw.hadoop.oozie.bindings.workflow_0_4_5.WorkflowSerializerCommon._
import com.directv.hw.hadoop.oozie.bindings.workflow_0_4_5.binding._
...
object pluginDescription {
  val jsonSchemaPath = "oozie/metadata/workflow_0_4_5/jsonSchema.json"
...
import com.directv.hw.hadoop.oozie.bindings.workflow_0_4_5.pluginDescription.jsonObject2extJsonHas
...
class ChgrpSerializer() extends JsonSerializer[CHGRP] {
  override def serialize(chgrp: CHGRP, typeOfSrc: Type, context: JsonSerializationContext): JsonElement = {
    val wrapper = new JsonObject
    wrapper.addProperty("recursive", chgrp.getRecursive != null)
    wrapper.addProperty("path", chgrp.getPath)
    wrapper.addProperty("group", chgrp.getGroup)
    wrapper.addProperty("dir-files", chgrp.getDirFiles)
    wrapper
  }
}
...
class SubworkflowDeserializer() extends JsonDeserializer[SUBWORKFLOW] {
  ...
  override def deserialize(json: JsonElement, typeOfT: Type, context: JsonDeserializationContext)  = {
    ...
    if (subworkflowJson != null) {
      ...
      if (subworkflow.getConfiguration.getProperty.isEmpty) subworkflow.setConfiguration(null)
    }
    subworkflow
  }
}
  ...
  override def deserialize(javaJson: JsonElement, typeOfT: Type, context: JsonDeserializationContext) = {
    ...
    if (json != null) {
      ...
      if (json.has("javaOptsOrJavaOpt")) json.getAsJsonArray("javaOptsOrJavaOpt") foreach {choice ⇒
        ...
        if (javaOptsOrJavaOpt.hasStringData("java-opts")) java.setJavaOpts(javaOptsOrJavaOpt.get("java-opts").getAsString)
