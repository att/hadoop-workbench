...
import com.directv.hw.hadoop.oozie.bindings.workflow_0_4.GlobalSerializer
...
class WorkflowToGraphConverterImpl_0_4 extends WorkflowToGraphConverterBase with LazyLogging {

  // workflow version this converter supports
  override def getSupportedWorkflowVersion: String = "0.4"

  import WorkflowConverter.Oozie

  def getJsonSchemaAsString: String = com.directv.hw.hadoop.oozie.bindings.workflow_0_4.pluginDescription.getJsonSchemaAsString
  ...
  override lazy val pluginSerializers: List[(Class[_], Class[_])] =
    com.directv.hw.hadoop.oozie.bindings.shell_action_0_3.pluginDescription.additionalSerializers ++
      ...
      com.directv.hw.hadoop.oozie.bindings.workflow_0_4.pluginDescription.additionalSerializers ++
  ...
  override protected def getNodeBindings: List[Class[_]] = {
    List(
      classOf[com.directv.hw.hadoop.oozie.bindings.workflow_0_4.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.hive_action_0_4.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.sqoop_action_0_4.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.spark_action_0_1.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.spark_action_0_2.binding.ACTION]
    )
  }
}
