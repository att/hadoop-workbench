...
@XmlType(name = "CREDENTIAL", propOrder = Array("property"), namespace = "uri:oozie:workflow:0.4.5") object CREDENTIAL {
...
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "CREDENTIAL", propOrder = Array("property"), namespace = "uri:oozie:workflow:0.4.5") class CREDENTIAL {
