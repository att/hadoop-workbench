...
@XmlType(name = "CONFIGURATION", propOrder = Array("property"), namespace = "uri:oozie:workflow:0.3") object CONFIGURATION {
...
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "CONFIGURATION", propOrder = Array("property"), namespace = "uri:oozie:workflow:0.3") class CONFIGURATION {
  @XmlElement(required = true)
