package com.directv.hw.hadoop.oozie.bindings.email_action_0_2

import java.io.InputStream
import java.lang.reflect.Type

import com.directv.hw.core.exception.DapException
import com.directv.hw.hadoop.oozie.bindings.email_action_0_2.binding._
...
object pluginDescription {
  val jsonSchemaPath = "oozie/metadata/email_action_0_2/jsonSchema.json"
...
class ActionDeserializer() extends JsonDeserializer[ACTION] {
  ...
  override def deserialize(actionJson: JsonElement, typeOfT: Type, context: JsonDeserializationContext) = {
    ...
    if (json != null) {
      ...
      if (json.hasStringData("content_type")) action.setContentType(json.get("content_type").getAsString)
    }
    action
  }
}
