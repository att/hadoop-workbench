...
//import com.directv.hw.web.ingest.oozie.model.workflow_0_4_5.binding.TOUCHZ
...
@XmlType(name = "FS", propOrder = Array("nameNode", "jobXml", "configuration", "deleteOrMkdirOrMove"), namespace = "uri:oozie:workflow:0.4.5")
