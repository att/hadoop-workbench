...
@XmlType(name = "CONFIGURATION", propOrder = Array("property"), namespace = "uri:oozie:spark-action:0.2")
object CONFIGURATION {


  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = Array("name", "value", "description"), namespace = "uri:oozie:spark-action:0.2")
  class Property {
