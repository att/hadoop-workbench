...
import com.directv.hw.hadoop.oozie.bindings.workflow_0_4_5.GlobalSerializer
...
class WorkflowToGraphConverterImpl_0_4_5 extends WorkflowToGraphConverterBase with LazyLogging {

  // workflow version this converter supports
  override def getSupportedWorkflowVersion: String = "0.4.5"

  import WorkflowConverter.Oozie

  def getJsonSchemaAsString: String = com.directv.hw.hadoop.oozie.bindings.workflow_0_4_5.pluginDescription.getJsonSchemaAsString
  ...
  override lazy val pluginSerializers: List[(Class[_], Class[_])] =
    com.directv.hw.hadoop.oozie.bindings.shell_action_0_3.pluginDescription.additionalSerializers ++
      ...
      com.directv.hw.hadoop.oozie.bindings.workflow_0_4_5.pluginDescription.additionalSerializers ++
  ...
  override protected def getNodeBindings: List[Class[_]] = {
    List(
      classOf[com.directv.hw.hadoop.oozie.bindings.workflow_0_4_5.binding.ACTION]
    )
  }
}
