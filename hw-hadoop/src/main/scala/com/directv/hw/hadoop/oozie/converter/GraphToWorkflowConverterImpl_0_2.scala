...
class GraphToWorkflowConverterImpl_0_2 extends GraphToWorkflowConverterBase with LazyLogging {
  ...
  override lazy val pluginDeserializers: List[(Class[_], Class[_])] =
    com.directv.hw.hadoop.oozie.bindings.shell_action_0_3.pluginDescription.additionalDeserializers ++
      ...
      com.directv.hw.hadoop.oozie.bindings.workflow_0_2.pluginDescription.additionalDeserializers ++
