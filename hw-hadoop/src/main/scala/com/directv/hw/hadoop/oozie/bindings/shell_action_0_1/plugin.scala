package com.directv.hw.hadoop.oozie.bindings.shell_action_0_1

import java.io.InputStream
import java.lang.reflect.Type

import com.directv.hw.core.exception.DapException
import com.directv.hw.hadoop.oozie.bindings.shell_action_0_1.WorkflowSerializerCommon._
import com.directv.hw.hadoop.oozie.bindings.shell_action_0_1.binding.{FLAG, _}
...
object pluginDescription {
  val jsonSchemaPath = "oozie/metadata/shell_action_0_1/jsonSchema.json"
...
class ActionSerializer() extends JsonSerializer[ACTION] {
  ...
  override def serialize(action: ACTION, typeOfSrc: Type, context: JsonSerializationContext): JsonElement = {
    ...
    result.addProperty("job-xml", action.getJobXml)
    addConfiguration(result, action.getConfiguration, context)
    result.addProperty("exec", action.getExec)
