...
//import com.directv.hw.web.ingest.oozie.model.workflow_0_2_5.binding.PREPARE
...
@XmlType(name = "JAVA", propOrder = Array("jobTracker", "nameNode", "prepare", "jobXml", "configuration", "mainClass", "javaOpts",
  "arg", "file", "archive", "captureOutput"), namespace = "uri:oozie:workflow:0.2.5") class JAVA {
