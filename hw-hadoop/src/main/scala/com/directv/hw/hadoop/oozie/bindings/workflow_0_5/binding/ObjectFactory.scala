...
@XmlRegistry object ObjectFactory {
  private val _Kill_QNAME: QName = new QName("uri:oozie:workflow:0.5", "kill")
  private val _Switch_QNAME: QName = new QName("uri:oozie:workflow:0.5", "switch")
  private val _Pig_QNAME: QName = new QName("uri:oozie:workflow:0.5", "pig")
  private val _WorkflowApp_QNAME: QName = new QName("uri:oozie:workflow:0.5", "workflow-app")
  private val _Fs_QNAME: QName = new QName("uri:oozie:workflow:0.5", "fs")
  private val _SubWorkflow_QNAME: QName = new QName("uri:oozie:workflow:0.5", "sub-workflow")
  private val _Java_QNAME: QName = new QName("uri:oozie:workflow:0.5", "java")
  private val _MapReduce_QNAME: QName = new QName("uri:oozie:workflow:0.5", "map-reduce")
}
...
@XmlRegistry class ObjectFactory {
  ...
  @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "kill") def createKill(value: KILL): JAXBElement[KILL] = new JAXBElement[KILL](ObjectFactory._Kill_QNAME, classOf[KILL], null, value)

  @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "switch") def createSwitch(value: SWITCH): JAXBElement[SWITCH] = new
      JAXBElement[SWITCH](ObjectFactory._Switch_QNAME, classOf[SWITCH], null, value)

  @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "pig") def createPig(value: PIG): JAXBElement[PIG] = new JAXBElement[PIG] (ObjectFactory._Pig_QNAME, classOf[PIG], null, value)

  @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "workflow-app") def createWorkflowApp(value: WORKFLOWAPP): JAXBElement[WORKFLOWAPP]
  = new JAXBElement[WORKFLOWAPP](ObjectFactory._WorkflowApp_QNAME, classOf[WORKFLOWAPP], null, value)

  @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "fs") def createFs(value: FS): JAXBElement[FS] = new JAXBElement[FS](ObjectFactory
    ._Fs_QNAME, classOf[FS], null, value)

  @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "sub-workflow") def createSubWorkflow(value: SUBWORKFLOW): JAXBElement[SUBWORKFLOW]
  = new JAXBElement[SUBWORKFLOW](ObjectFactory._SubWorkflow_QNAME, classOf[SUBWORKFLOW], null, value)

  @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "java") def createJava(value: JAVA): JAXBElement[JAVA] = new JAXBElement[JAVA] (ObjectFactory._Java_QNAME, classOf[JAVA], null, value)

  @XmlElementDecl(namespace = "uri:oozie:workflow:0.5", name = "map-reduce") def createMapReduce(value: MAPREDUCE): JAXBElement[MAPREDUCE] =
