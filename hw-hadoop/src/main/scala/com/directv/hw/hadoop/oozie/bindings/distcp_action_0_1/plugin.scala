package com.directv.hw.hadoop.oozie.bindings.distcp_action_0_1

import java.io.InputStream
import java.lang.reflect.Type

import com.directv.hw.core.exception.DapException
import com.directv.hw.hadoop.oozie.bindings.distcp_action_0_1.WorkflowSerializerCommon._
import com.directv.hw.hadoop.oozie.bindings.distcp_action_0_1.binding._
...
object pluginDescription {
  val jsonSchemaPath = "oozie/metadata/distcp_action_0_1/jsonSchema.json"
...
class ActionDeserializer() extends JsonDeserializer[ACTION] {
  implicit val propertyType = classOf[CONFIGURATION.Property]
  implicit val configurationType = classOf[CONFIGURATION]

  import WorkflowSerializerCommon._
