...
@XmlRootElement(name = "hive", namespace = "uri:oozie:hive-action:0.3")
@XmlType(name = "ACTION", namespace = "uri:oozie:hive-action:0.3", propOrder = Array("jobTracker", "nameNode", "prepare", "jobXml",
