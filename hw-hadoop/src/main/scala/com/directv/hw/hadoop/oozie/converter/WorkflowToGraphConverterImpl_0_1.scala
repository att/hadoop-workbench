...
import com.directv.hw.hadoop.oozie.bindings.workflow_0_1.binding._
...
class WorkflowToGraphConverterImpl_0_1 extends WorkflowToGraphConverterBase with LazyLogging {

  // workflow version this converter supports
  override def getSupportedWorkflowVersion: String = "0.1"

  import WorkflowConverter.Oozie

  def getJsonSchemaAsString: String = com.directv.hw.hadoop.oozie.bindings.workflow_0_1.pluginDescription.getJsonSchemaAsString
  ...
  override lazy val pluginSerializers: List[(Class[_], Class[_])] =
    com.directv.hw.hadoop.oozie.bindings.shell_action_0_3.pluginDescription.additionalSerializers ++
      ...
      com.directv.hw.hadoop.oozie.bindings.workflow_0_1.pluginDescription.additionalSerializers ++
  ...
  def extractAction(action: ACTION): (Any, String, String) = {
    Option(action.getMapReduce) map { mapReduce =>
      ...
      (action.getSsh, "ssh", getSupportedWorkflowVersion),
  ...
  override protected def getNodeBindings: List[Class[_]] = {
    List(
      classOf[com.directv.hw.hadoop.oozie.bindings.workflow_0_1.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.distcp_action_0_1.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.shell_action_0_1.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.spark_action_0_1.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.email_action_0_1.binding.ACTION],
      classOf[com.directv.hw.hadoop.oozie.bindings.ssh_action_0_1.binding.ACTION]
    )
  }
}
