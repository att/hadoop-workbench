...
//import com.directv.hw.web.ingest.oozie.model.workflow_0_4.binding.TOUCHZ
...
@XmlType(name = "FS", propOrder = Array("nameNode", "jobXml", "configuration", "deleteOrMkdirOrMove"), namespace = "uri:oozie:workflow:0.4")
@XmlSeeAlso(Array(classOf[DELETE], classOf[MKDIR], classOf[MOVE], classOf[CHMOD], classOf[TOUCHZ])) class FS {
