...
@XmlRootElement(name = "action", namespace = "uri:oozie:workflow:0.1")
@XmlType(name = "ACTION", propOrder = Array("name",
  "mapReduce", "pig", "ssh", "subWorkflow", "fs", "java",
  ...
  , namespace = "uri:oozie:workflow:0.1") class ACTION {
