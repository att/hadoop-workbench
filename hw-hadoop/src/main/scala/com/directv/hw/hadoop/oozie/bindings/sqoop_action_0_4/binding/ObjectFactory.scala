...
@XmlRegistry object ObjectFactory {
  private val _Sqoop_QNAME: QName = new QName("uri:oozie:sqoop-action:0.4", "sqoop")
}
...
@XmlRegistry class ObjectFactory {
  ...
  @XmlElementDecl(namespace = "uri:oozie:sqoop-action:0.4", name = "sqoop") def createSqoop(value: ACTION): JAXBElement[ACTION] =
