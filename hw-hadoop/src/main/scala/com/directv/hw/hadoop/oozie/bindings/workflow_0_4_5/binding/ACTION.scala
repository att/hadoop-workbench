...
@XmlRootElement(name = "action", namespace = "uri:oozie:workflow:0.4.5")
@XmlType(name = "ACTION", propOrder = Array("name", "cred", "retryMax", "retryInterval",
  "mapReduce", "pig", "subWorkflow", "fs", "java",
  "sqoop_0_4", "sqoop_0_3", "sqoop_0_2",
  "ssh_0_2", "ssh_0_1",
  "shell_0_3", "shell_0_2", "shell_0_1", "spark_0_1", "spark_0_2",
  "hive_0_5", "hive_0_4", "hive_0_3", "hive_0_2",
  "email_0_2","email_0_1",
  "distcp_0_2", "distcp_0_1",
  "ok", "error"
)
  , namespace = "uri:oozie:workflow:0.4.5") class ACTION {
  ...
  @XmlElement(name = "spark", namespace = "uri:oozie:spark-action:0.2")
  @BeanProperty var spark_0_2: com.directv.hw.hadoop.oozie.bindings.spark_action_0_2.binding.ACTION = null
  // hive
  ...
  @BeanProperty var cred: String = null
  @XmlAttribute(name = "retry-max")
  @SerializedName("retry-max")
  @BeanProperty var retryMax: String = null
  @XmlAttribute(name = "retry-interval")
  @SerializedName("retry-interval")
  @BeanProperty var retryInterval: String = null
