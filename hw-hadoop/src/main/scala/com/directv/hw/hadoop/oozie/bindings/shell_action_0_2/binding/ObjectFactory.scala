...
@XmlRegistry object ObjectFactory {
  private val _Shell_QNAME: QName = new QName("uri:oozie:shell-action:0.2", "shell")
}
...
@XmlRegistry class ObjectFactory {
  ...
  @XmlElementDecl(namespace = "uri:oozie:shell-action:0.2", name = "shell") def createShell(value: ACTION): JAXBElement[ACTION] =
