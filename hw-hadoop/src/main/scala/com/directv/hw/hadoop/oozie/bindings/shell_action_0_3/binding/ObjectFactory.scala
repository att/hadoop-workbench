...
@XmlRegistry object ObjectFactory {
  private val _Shell_QNAME: QName = new QName("uri:oozie:shell-action:0.3", "shell")
}
...
@XmlRegistry class ObjectFactory {
  ...
  @XmlElementDecl(namespace = "uri:oozie:shell-action:0.3", name = "shell") def createShell(value: ACTION): JAXBElement[ACTION] =
