...
@XmlRegistry object ObjectFactory {
  private val _Spark_QNAME: QName = new QName("uri:oozie:spark-action:0.2", "shell")
}
...
@XmlRegistry class ObjectFactory {
  ...
  @XmlElementDecl(namespace = "uri:oozie:spark-action:0.2", name = "spark") def createShell(value: ACTION): JAXBElement[ACTION] =
