package com.directv.hw.hadoop.oozie.bindings.workflow_0_4

import java.io.InputStream
import java.lang.reflect.Type

import com.directv.hw.core.exception.DapException
import com.directv.hw.hadoop.oozie.bindings.workflow_0_4.WorkflowSerializerCommon._
import com.directv.hw.hadoop.oozie.bindings.workflow_0_4.binding._
...
object pluginDescription {
  val jsonSchemaPath = "oozie/metadata/workflow_0_4/jsonSchema.json"
...
import com.directv.hw.hadoop.oozie.bindings.workflow_0_4.pluginDescription.jsonObject2extJsonHas
...
class ChmodSerializer() extends JsonSerializer[CHMOD] {
  override def serialize(chmod: CHMOD, typeOfSrc: Type, context: JsonSerializationContext): JsonElement = {
    val wrapper = new JsonObject
    wrapper.addProperty("recursive", chmod.getRecursive != null)
    wrapper.addProperty("path", chmod.getPath)
    wrapper.addProperty("permissions", chmod.getPermissions)
    wrapper.addProperty("dir-files", chmod.getDirFiles)
    wrapper
  }
}
class ChmodDeserializer() extends JsonDeserializer[CHMOD] {
  ...
  override def deserialize(json: JsonElement, typeOfT: Type, context: JsonDeserializationContext)  = {
    ...
    val wrapper = json.getAsJsonObject
    if (wrapper != null) {
      val innerChmod = wrapper.get("chmod").getAsJsonObject
      if (innerChmod.has("recursive")) if (innerChmod.get("recursive").getAsBoolean) chmod.setRecursive(new FLAG())
      if (innerChmod.hasStringData("path")) chmod.setPath(innerChmod.get("path").getAsString)
      if (innerChmod.hasStringData("permissions")) chmod.setPermissions(innerChmod.get("permissions").getAsString)
      if (innerChmod.hasStringData("dir-files")) chmod.setDirFiles(innerChmod.get("dir-files").getAsString)
    }
    chmod
  }
}
...
class TouchzDeserializer() extends JsonDeserializer[TOUCHZ] {
  ...
  override def deserialize(json: JsonElement, typeOfT: Type, context: JsonDeserializationContext)  = {
    ...
    if (wrapper != null && wrapper.get("touchz") != null) {
      val innerTouchz = wrapper.get("touchz").getAsJsonObject
      if (innerTouchz.hasStringData("path")) touchz.setPath(innerTouchz.get("path").getAsString)
    }
    touchz
  }
}
...
class ActionDeserializer() extends JsonDeserializer[ACTION] {
  ...
  override def deserialize(actionJson: JsonElement, typeOfT: Type, context: JsonDeserializationContext) = {
    ...
    if (json != null) {
      ...
      if (json.has("sqoop_0_4")) action.setSqoop_0_4(context.deserialize(json.get("sqoop_0_4"), classOf[com.directv.hw.hadoop.oozie.bindings
      .sqoop_action_0_4.binding.ACTION]))
      if (json.has("sqoop_0_3")) action.setSqoop_0_3(context.deserialize(json.get("sqoop_0_3"), classOf[com.directv.hw.hadoop.oozie.bindings
      .sqoop_action_0_3.binding.ACTION]))
      if (json.has("sqoop_0_2")) action.setSqoop_0_2(context.deserialize(json.get("sqoop_0_2"), classOf[com.directv.hw.hadoop.oozie.bindings
      .sqoop_action_0_2.binding.ACTION]))
      if (json.has("ssh_0_2")) action.setSsh_0_2(context.deserialize(json.get("ssh_0_2"), classOf[com.directv.hw.hadoop.oozie.bindings
      .ssh_action_0_2.binding.ACTION]))
      if (json.has("ssh_0_1")) action.setSsh_0_1(context.deserialize(json.get("ssh_0_1"), classOf[com.directv.hw.hadoop.oozie.bindings
      .ssh_action_0_1.binding.ACTION]))
      if (json.has("shell_0_3")) action.setShell_0_3(context.deserialize(json.get("shell_0_3"), classOf[com.directv.hw.hadoop.oozie.bindings
      .shell_action_0_3.binding.ACTION]))
      if (json.has("shell_0_2")) action.setShell_0_2(context.deserialize(json.get("shell_0_2"), classOf[com.directv.hw.hadoop.oozie.bindings
      .shell_action_0_2.binding.ACTION]))
      if (json.has("shell_0_1")) action.setShell_0_1(context.deserialize(json.get("shell_0_1"), classOf[com.directv.hw.hadoop.oozie.bindings
      .shell_action_0_1.binding.ACTION]))
      if (json.has("spark_0_1")) action.setSpark_0_1(context.deserialize(json.get("spark_0_1"), classOf[com.directv.hw.hadoop.oozie.bindings
      .spark_action_0_1.binding.ACTION]))
      if (json.has("spark_0_2")) action.setSpark_0_2(context.deserialize(json.get("spark_0_2"), classOf[com.directv.hw.hadoop.oozie.bindings
      .spark_action_0_2.binding.ACTION]))
      if (json.has("hive_0_5")) action.setHive_0_5(context.deserialize(json.get("hive_0_5"), classOf[com.directv.hw.hadoop.oozie.bindings
      .hive_action_0_5.binding.ACTION]))
      if (json.has("hive_0_4")) action.setHive_0_4(context.deserialize(json.get("hive_0_4"), classOf[com.directv.hw.hadoop.oozie.bindings
      .hive_action_0_4.binding.ACTION]))
      if (json.has("hive_0_3")) action.setHive_0_3(context.deserialize(json.get("hive_0_3"), classOf[com.directv.hw.hadoop.oozie.bindings
      .hive_action_0_3.binding.ACTION]))
      if (json.has("hive_0_2")) action.setHive_0_2(context.deserialize(json.get("hive_0_2"), classOf[com.directv.hw.hadoop.oozie.bindings
      .hive_action_0_2.binding.ACTION]))
      if (json.has("email_0_2")) action.setEmail_0_2(context.deserialize(json.get("email_0_2"), classOf[com.directv.hw.hadoop.oozie.bindings
      .email_action_0_2.binding.ACTION]))
      if (json.has("email_0_1")) action.setEmail_0_1(context.deserialize(json.get("email_0_1"), classOf[com.directv.hw.hadoop.oozie.bindings
      .email_action_0_1.binding.ACTION]))
