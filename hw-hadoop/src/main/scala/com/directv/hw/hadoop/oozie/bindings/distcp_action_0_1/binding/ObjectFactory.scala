...
@XmlRegistry object ObjectFactory {
  private val _Distcp_QNAME: QName = new QName("uri:oozie:distcp-action:0.1", "distcp")
}
...
@XmlRegistry class ObjectFactory {
  ...
  @XmlElementDecl(namespace = "uri:oozie:distcp-action:0.1", name = "distcp") def createDistcp(value: ACTION): JAXBElement[ACTION] =
