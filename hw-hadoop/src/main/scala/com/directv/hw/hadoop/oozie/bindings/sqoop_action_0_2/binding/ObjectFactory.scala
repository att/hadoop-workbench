...
@XmlRegistry object ObjectFactory {
  private val _Sqoop_QNAME: QName = new QName("uri:oozie:sqoop-action:0.2", "sqoop")
}
...
@XmlRegistry class ObjectFactory {
  ...
  @XmlElementDecl(namespace = "uri:oozie:sqoop-action:0.2", name = "sqoop") def createSqoop(value: ACTION): JAXBElement[ACTION] =
