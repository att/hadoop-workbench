define(function (require) {
    ...
    require('../ngModule').factory('cluster-configuration.FileManager', getFileManager);

    getFileManager.$inject = ["cluster-configuration.restService", "file-browser.file-helper", "$q"];
