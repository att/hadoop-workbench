define(function (require) {
    ...
    require('../ngModule').controller('configuration-widget.IndexController', Controller);

    Controller.$inject = [
        "$scope",
        "dashboard.models.TabPage",
        "$dashboardWidget",
        "configuration.ActionsCreator",
        "configuration.Store",
        "fileManager",
    ...
    /*jshint maxparams: 11*/
    function Controller($scope, TabPage, $dashboardWidget, ActionsCreator, Store, fileManager, alertsManagerService, restService, $widgetParams, $q, lockProvider, settingsWriteAccess) {
        $dashboardWidget.title = "Configuration";
        ...
        $scope.widget.leftTabManager.addTab(TabPage.factory({
            ...
            params: {
                ...
                isReadonly: !settingsWriteAccess
            }
        ...
        function saveFile(file) {
            ...
            restService.saveFile(file.path, file.text).then(function () {
