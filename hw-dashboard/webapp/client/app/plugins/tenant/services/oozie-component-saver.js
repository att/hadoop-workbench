define(function (require) {
    ...
    require('../ngModule').factory('tenant.OozieComponentSaver', getComponentSaver);

    getComponentSaver.$inject = ["$q", "oozie.restService"];

    function getComponentSaver($q, restService) {

        function ComponentSaver(templateId) {
            ...
            save: function (workflow, workflowFilePath, propertyFiles) {
                ...
                return $q(function (resolve, reject) {
                    ...
                    let workflowOperation = {
                        ...
                        promise: restService.updateTenantWorkflow('v1.0', self.templateId, workflow, workflowFilePath)
                    };
                    ...
                    propertyFiles.map((f) => {
                        let fileOperation = {
                            ...
                            hideErrorNotification: false,
                            promise: restService.saveTenantFileAsConfig('v1.0', self.templateId, f.file.path, f.config)
                        };
